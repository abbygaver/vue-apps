...
const _hoisted_1$4 = { class: "navbar navbar-expand-lg bg-body-tertiary" };
...
const _hoisted_7$1 = { class: "nav-item" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createBaseVNode("main", {
          ...
          createVNode(unref(RouterView), { main: main2.value }, null, 8, ["main"])
        ], 512)
      ], 64);
    };
  }
};
const _imports_0 = "/app13/sunset.jpg";
const _sfc_main$5 = {
  __name: "Heading",
  props: ["label"],
  setup(__props) {
    const props = __props;
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("h1", null, toDisplayString(props.label), 1);
    };
  }
};
const HomeView_vue_vue_type_style_index_0_lang = "";
const _hoisted_1$3 = { class: "card" };
const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("div", { class: "card-body" }, [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createVNode(_sfc_main$5, { label: "Home" }),
        _hoisted_2$1
      ]);
    };
  }
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("h2", null, toDisplayString(name.value), 1),
        createBaseVNode("h3", null, toDisplayString(desc.value), 1)
      ], 64);
    };
  }
};
...
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("h2", null, "There is no item with this name. Get it together. :/", -1);
const _hoisted_7 = [
  _hoisted_6
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    function setLabel() {
      ...
      id ? "${route.name} ${itemDesc.name}" : route.name;
    }
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2, [
          _ctx.$route.params.id ? (openBlock(), createElementBlock("div", _hoisted_3, [
            unref(itemGo) ? (openBlock(), createElementBlock("div", _hoisted_4, [
              createVNode(_sfc_main$3, {
                name: unref(itemGo).name
              }, null, 8, ["name"]),
              createVNode(_sfc_main$2, {
                src: unref(itemGo).image
              }, null, 8, ["src"]),
              createVNode(_sfc_main$3, {
                desc: unref(itemGo).desc
              }, null, 8, ["desc"])
            ])) : (openBlock(), createElementBlock("div", _hoisted_5, _hoisted_7))
          ])) : (openBlock(), createElementBlock("div", _hoisted_8, [
            createTextVNode(" Items "),
            createBaseVNode("ul", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(itemList), (item, index) => {
...
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("div", null, "Aw...that sucks try again.", -1);
const _sfc_main = {
  __name: "NotFound",
  props: ["main"],
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_sfc_main$5, { label: "404 - File not found" }),
        _hoisted_1
      ], 64);
    };
  }
